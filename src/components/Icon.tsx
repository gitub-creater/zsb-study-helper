...
const P: Record<string, string[]> = {
  ...
  volumeOff: ['M4 9.5v5h3.5L13 19V5L7.5 9.5H4z', 'M16 9l4 6', 'M20 9l-4 6', 'M3 3l18 18'],
  ...
  palette: ['M12 3a9 9 0 1 0 0 18c1.4 0 2-.9 2-1.8 0-1.4-1.2-1.9-1.2-3 0-1 .8-1.7 2-1.7H17a4 4 0 0 0 4-4C21 6.5 17 3 12 3z', 'M7.5 10.5h.01', 'M10 7h.01', 'M14.5 7h.01', 'M17 10.5h.01'],
  thumb: ['M7 11v9', 'M7 11.5 11 4c1.5 0 2.3 1 2.3 2.2 0 .9-.8 3.3-.8 3.3h5.2c1 0 1.8.9 1.6 1.9l-1.2 6.5A2 2 0 0 1 16.1 20H7', 'M7 11H4v9h3'],
  bookmark: ['M7 4h10a1 1 0 0 1 1 1v15l-6-3.5L6 20V5a1 1 0 0 1 1-1z'],
  video: ['M4 7h11a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V8a1 1 0 0 1 1-1z', 'M16 10.5 20.5 8v8L16 13.5'],
